...
class DetailNewScreen extends StatefulWidget {
  DetailNewScreen({required this.id});
...
class _DetailNewScreenState extends State<DetailNewScreen> {
  ...
  void didChangeDependencies() {
    houseDetail = Provider.of<SearchLoadouts>(context)
        .getData('d1caed70-2467-4620-b295-e8a8e671a424');
    Provider.of<RecommandedHouses>(context, listen: false)
        .getRecommandedData(112.toString())
        .then((_) {
      setState(() {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          children: [
                            // IconButton(onPressed: (){}, icon: Icons.car
                            // ),
                          ...
                          child: Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                  ...
                                  child: Text(
                                    '${loadedProduct.selectedPropertyType}',
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                '${value.format(100000)} ${detailProperty.enumCurrencyType}',
                                style: const TextStyle(
                                  color: Colors.green,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                        ...
                        Container(
                          margin: const EdgeInsets.only(left: 5),
                          child: Text(
                            '${loadedProduct.beds}bds | ${loadedProduct.garage}ga |${value.format(detailProperty.area)} sq m',
                            style: const TextStyle(
                              //fontWeight: FontWeight.bold,
                              color: Colors.black,
                              fontSize: 16,
                        ...
                        Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                DetailForm(
                                  dataValue: '${loadedProduct.beds} ',
                                  value: 'Beds ',
                                ),
                                DetailForm(
                                  dataValue: '${loadedProduct.garage} ',
                                  value: 'Garages ',
                                ),
                                DetailForm(
                                  dataValue: features.isEmpty
                                      ? 'Best product use it'
                                      : features,
                                  value: 'Features ',
                                ),
                        ...
                        Container(
                          ...
                          child: Text(
                            ' ${convertUTF8(loadedProduct.description)}',
                            style: const TextStyle(
