...
import '../screens/recommanded_house_screen.dart';
import '../widget_file/detail_form.dart';

class ProductDetail extends StatefulWidget {
  String? productUid, id;
  ProductDetail({this.productUid, this.id});
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(
                            ...
                            child: const RecommandedHousesScreen())
                      ],
                    ),
                  ));
            }
